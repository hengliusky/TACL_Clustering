...
def kmeans(
    ...
    for i in range(20):
        ...
        # print(initial_state)
        # print("===========")
        # print(pairwise_distance_function(X, initial_state))
        dis = pairwise_distance_function(X, initial_state).sum()
        # print("dis=", dis)
        if dis < dis_min and initial_state is not None:
            dis_min = dis
    ...
    while True:
        ...
        for index in range(num_clusters):
            ...
            if selected.numel() > 0:
                ...
                # If no points are assigned to the cluster, reinitialize the center
                initial_state[index] = initialize(X, 1).to(device)
